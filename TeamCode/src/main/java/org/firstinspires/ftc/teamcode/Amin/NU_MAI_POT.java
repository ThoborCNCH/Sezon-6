...
public class NU_MAI_POT {
    ...
    public static double power_coborare = -0.3;
    public static double power_brat_dc_cob = .7;

    public static double power_reven = 0.2;
    public static double poz_deschis_st = 0.37;
    public static double poz_deschis_dr = 0.65;
    public static double poz_inchis_st = 0.25;
    ...
    public static Pose2d PRE_POSITION_DR_RED_BLUE = new Pose2d(43, -10, Math.toRadians(90));
    public static Pose2d JUNCTION_PUNE_DR_RED_BLUE = new Pose2d(38.7, -1.5, Math.toRadians(130));
    public static Vector2d JUNCTION_PUNE_DR_RED_BLUE_VECTOR = new Vector2d(32.4, -4.2);
    public static Pose2d STACK_DR_RED_BLUE = new Pose2d(67, -8.5, Math.toRadians(0));
    ...
    public static Vector2d JUNCTION_PUNE_ST_RED_BLUE_VECTOR = new Vector2d(-32.5, -4.2);
