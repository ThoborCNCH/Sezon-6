...
//        robot.setIntake(0);
        ...
        TrajectorySequence ia = robot.trajectorySequenceBuilder(aproape_saPui.end())
                .splineToLinearHeading(new Pose2d(-38,-20, Math.toRadians(180)), Math.toRadians(-20))
                .splineToLinearHeading(new Pose2d(-58, -21, Math.toRadians(180)), Math.toRadians(-20),
                        SampleMecanumDrive.getVelocityConstraint(DriveConstants.MAX_VEL, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(26)
                )
                .addDisplacementMarker(t -> t * 0.3, () -> {
                    robot.setGliseraPower(-.4);
                })
                .addDisplacementMarker(t -> t * 0.389 , () -> {
                    robot.setGliseraPower(0);
                })
                .build();
