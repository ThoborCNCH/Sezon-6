...
import static org.firstinspires.ftc.teamcode.Amin.NU_MAI_POT.PRE_POSITION_ST_RED_BLUE;
...
//            sleep(10000);
        Trajectory go_pune = robot.trajectoryBuilder(robot.getPoseEstimate())
                .lineToLinearHeading(PRE_POSITION_ST_RED_BLUE,
        ...
        Trajectory efectiv = robot.trajectoryBuilder(go_pune.end())
                .splineToConstantHeading(JUNCTION_PUNE_ST_RED_BLUE_VECTOR, Math.toRadians(90))
                .addTemporalMarker(time -> time * 0, () -> {
                    robot.se_ridica_brat(power_brat_dc);
                })
                .build();
